 ...
 *  音频采样率
 */
typedef NS_ENUM(NSUInteger, NIMAVChatAudioSamplerate) {
    /**
     *  8k
     */
    NIMAVChatAudioSamplerate8000 = 0,
    /**
     *  16k
     */
    NIMAVChatAudioSamplerate16000,
    /**
     *  32k
     */
    NIMAVChatAudioSamplerate32000,
    /**
     *  48k
     */
    NIMAVChatAudioSamplerate48000,
};
...
typedef NS_ENUM(NSUInteger, NIMNetCallSubscribeServerFbType) {
    /**
     * 上行网络较弱时，不对音视频流作回退处理，但不能保证音视频流的质量
     */
    NIMNetCallSubscribeServerFbTypeDisabled = 0,
    /**
     * (默认）上行网络较弱时可能暂时切小流或关闭视频发送
     */
    NIMNetCallSubscribeServerFbTypeAudioOnly = 2,
};
